...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'ksieber', 'email': 'ksieber@terpmail.umd.edu', 'first_name': 'Kevin', 'last_name': 'Sieber',
            'password': generate_password_hash('ksieber', method='pbkdf2:sha256'), 'role': 'STUDENT'},
